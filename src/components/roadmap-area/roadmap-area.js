...
const slider_data = [
  {
    id: 1,
    icon: (
      <img src="/icons/calculate.png" style={{ width: "60px" }} alt="img" />
    ),
    title: "Calculate",
  ...
  {
    id: 2,
    icon: <img src="/icons/goals.png" style={{ width: "60px" }} alt="img" />,
    title: "Set Targets",
  ...
  {
    id: 3,
    icon: <img src="/icons/reduce.png" style={{ width: "60px" }} alt="img" />,
    title: "Reduce",
  ...
  {
    id: 4,
    icon: <img src="/icons/offset.png" style={{ width: "60px" }} alt="img" />,
    title: "Offset",
  ...
  },
  {
    id: 5,
    icon: (
      <img src="/icons/collaboration.png" style={{ width: "60px" }} alt="img" />
    ),
  ...
  },
  {
    id: 6,
    icon: (
      <img src="/icons/communication.png" style={{ width: "60px" }} alt="img" />
    ),
                  ...
                  <SwiperSlide key={item.id}>
                    <div className="roadmap__hover">
                      <div className="roadmap__card">
                        ...
                        >
                          <div className="roadmap__percent ">{item.icon}</div>
