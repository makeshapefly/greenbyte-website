                ...
                <div className="about__facts-list">
                  <div className="about__icon-box">
                    <div style={{ padding: 20 }}>
                      <img src="/assets/img/retrofit/advise.svg" alt="Advise" />
                    </div>
                    <h5>Consult</h5>
                  </div>
                  <div className="about__icon-box">
                    <div style={{ padding: 20 }}>
                      <img src="/assets/img/retrofit/build.svg" alt="Build" />
                    </div>
                    <h5>Build</h5>
                  </div>
                  <div className="about__icon-box">
                    <div style={{ padding: 20 }}>
                      <img src="/assets/img/retrofit/collaborate.svg" alt="Collaborate" />
                    </div>
                    <h5>Collabarate</h5>
                  </div>
                </div>
